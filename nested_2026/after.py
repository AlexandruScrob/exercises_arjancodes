...
def build_customer_summary(customer: Customer, orders: list[Order]) -> Customer:
...
def generate_customer_report(
    ...
    orders_by_customer = group_orders_by_customer(orders=orders)

    for customer in customers:
        customer_orders = orders_by_customer.get(customer.id, [])
        summary = build_customer_summary(customer=customer, orders=customer_orders)
