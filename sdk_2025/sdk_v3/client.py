...
def get(endpoint: str, params: dict[str, Any] | None = None) -> httpx.Response:
    return request("GET", endpoint, params=params)


def post(endpoint: str, json: dict[str, Any] | None = None) -> httpx.Response:
    return request("POST", endpoint, json=json)


def put(endpoint: str, json: dict[str, Any] | None = None) -> httpx.Response:
