...
def _read_db_item(item_id: int, session: Session) -> DBItem:
...
def read_db_item(item_id: int, session: Session) -> Item:
    db_item = _read_db_item(item_id, session)
...
def create_db_item(item: ItemCreate, session: Session) -> Item:
